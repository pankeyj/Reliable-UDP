...
/*
	if(hdr->chksum == 0)
		cout << "###Check Sum is correct" << hdr->chksum<< endl;
	else
		cout << "###Check sum is WRONG" << hdr->chksum<<endl;
*/
	...
	while(isWriting)
	{
		cout << "Still trying to write" << endl;
...
/*
		if(hdr->chksum == 0)
        	        cout << "###Check Sum is correct" << endl;
	        else
			cout << "###Check sum is WRONG" << endl;
*/
